window.addEventListener("DOMContentLoaded", (event) => {
    ...
    if (foundClass) {
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 borders-between">
                            <div class="row pizza pizza-offer">
                                ...
                                <div class="col-lg-5">
                                    <form id="form-product-selection" class="borders-between">
                                        ...
                                        <div class="row size-and-type">
                                            <div class="col-md-6" data-lang="pizzaSize">
                                                ...
                                                <div class="product-option active">
                                                    <label>
                                                        S
                                                        <input type="radio" name="${data.pizza.size.name}" value="${data.pizza.size.value.small}" checked>
                                                    </label>
                                                </div>
                                                <div class="product-option">
                                                    <label>
                                                        M
                                                        <input type="radio" name="${data.pizza.size.name}" value="${data.pizza.size.value.medium}">
                                                    </label>
                                                </div>
                                                <div class="product-option">
                                                    <label>
                                                        L
                                                        <input type="radio" name="${data.pizza.size.name}" value="${data.pizza.size.value.large}">
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-6" data-lang="pizzaType">
                                                ...
                                                <div class="product-option type active">
                                                    <label>
                                                    بان
                                                        <input type="radio" name="${data.pizza.type.name}" value="${data.pizza.type.value.thin}" checked>
                                                    </label>
                                                </div>
                                                <div class="product-option type">
                                                    <label>
                                                    نحيفة
                                                        <input type="radio" name="${data.pizza.type.name}" value="${data.pizza.type.value.thick}">
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <button type="submit" class="btn custom-btn add-to-cart-btn custom-btn-with-icon"
                                                    data-lang="addPizzaToCart" data-name="${data.pizza.name.title}" data-price="${data.pizza.price}">
                                                    <span>
                                                        إضافة لعربة الشراء
                            ...
                            <div class="row suggestions pizza">
        ...
        $(function () {
            // price calculations for Offered Pizza
            console.log("Size changed"); // <-- added console.log statement
            var radio = $("input[name='pizza-size']");
            ...
            radio.on("change", function () {
                ...
                $("#quantity").on("change", function () {
                    ...
                    $(".pizza-offer button[data-price]").attr(
                        "data-price",
                        `${total}$`
                    );
                });
